-- Database: 'cse340 project', .public schema
--Assignment 2, Task 2: SQL Code
-- Rebuild File: database/db-rebuild.sql
-- Create ENUM type for account_type

CREATE TYPE public.account_type AS ENUM
    ('Client', 'Employee', 'Admin');

-- Set the owner of the account_type ENUM to cse340 user

ALTER TYPE public.account_type
    OWNER TO cse340;

-- Create the classification table to store vehicle classifications
...
-- Create the inventory table to store vehicle inventory
...
-- Add a foreign key relationship between inventory and classification tables
...
-- Insert initial data into the classification table
